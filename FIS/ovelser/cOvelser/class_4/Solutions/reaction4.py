...
while(choice):
	...
	t0=time.time()
	os.system("mpg123 go.mp3 &")									## Have a look at what happens if you do not put & at the end of this line? Can you notice the difference? Note, you may have to install mgp123 with sudo apt-get
	msgbox("Go")
